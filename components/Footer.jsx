...
const Footer = () => {
  ...
  <div className='border-t-2 mx-2 md:mx-44'></div>
    <p className={`${roboto} text-gray-700 flex justify-center mt-1 gap-5 text-sm font-semibold `}>lets catch up -
        <a target='_blank' className='mt-1 text-lg' href="https://x.com/MrShingne?t=8y5ycfGfNCP80sQ-jmOTYA&s=08"><FaXTwitter/></a>
        <a target='_blank' className='mt-1 text-lg' href="https://www.instagram.com/mr.shingne/?igshid=MzMyNGUyNmU2YQ%3D%3D"><FaInstagram/></a>
